...
export var ie = ie_upto10 || ie_11up || edge
export var ie_version = ie && (ie_upto10 ? document.documentMode || 6 : +(edge || ie_11up)[1])
export var webkit = !edge && /WebKit\//.test(userAgent)
var qtwebkit = webkit && /Qt\/\d+\.\d+/.test(userAgent)
export var chrome = !edge && /Chrome\//.test(userAgent)
...
export var ios = !edge && /AppleWebKit/.test(userAgent) && /Mobile\/\w+/.test(userAgent)
export var android = /Android/.test(userAgent)
