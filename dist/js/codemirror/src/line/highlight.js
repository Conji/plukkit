...
Context.prototype.lookAhead = function lookAhead (n) {
  var line = this.doc.getLine(this.line + n)
  if (line != null && n > this.maxLookAhead) { this.maxLookAhead = n }
  return line
};

Context.prototype.nextLine = function nextLine () {
  this.line++
  if (this.maxLookAhead > 0) { this.maxLookAhead-- }
};

Context.fromSaved = function fromSaved (doc, saved, line) {
...
Context.prototype.save = function save (copy) {
